...
const sourcePng = join(assetsDir, 'kopa.png');
const iconsetDir = join(assetsDir, 'kopa.iconset');
const icnsFile = join(assetsDir, 'kopa.icns');
...
function main() {
  console.log('Building macOS icon from kopa.png...');
